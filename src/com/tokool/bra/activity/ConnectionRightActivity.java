...
public class ConnectionRightActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_connection_right);
		...
		btnScan.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Animation anim=AnimationUtils.loadAnimation(ConnectionRightActivity.this, R.anim.anim_scan_rotate);
		...
		lvDevices.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view, final int position, long arg3) {
				...
				if((Boolean)devices.get(position).get("status")){
					Toast.makeText(ConnectionRightActivity.this, getString(R.string.bound), Toast.LENGTH_SHORT).show();
				}else{
					dialog.show();
	...
	private LeScanCallback mLeScanCallback=new LeScanCallback() {
		...
		@Override
		public void onLeScan(BluetoothDevice btDevice, int rssi, byte[] scanRecord) {Log.d("zz", "device:"+btDevice.getAddress());
			// TODO Auto-generated method stub
			String name=btDevice.getName();
			if(name!=null && name.equals("miss_bra_R")){
	...
	private class MyBroadcastReceiver extends BroadcastReceiver{
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(action.equals("device_connected")){
				...
				Toast.makeText(ConnectionRightActivity.this, getString(R.string.binding_finished), Toast.LENGTH_SHORT).show();
				adapter.notifyDataSetChanged();
